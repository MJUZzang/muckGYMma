...
interface AddCircleV2Props {
    className?: string;
    size?: number;
}

function AddCircleV2({
    ...
    return (
        ...
        >
            ...
            <path d="M12 8L12 16" strokeLinejoin="round" />
            <path d="M16 12L8 12" strokeLinejoin="round" />
        </svg>
    );
}

export default AddCircleV2;
